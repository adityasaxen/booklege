  ...
  Future<void> downloadPDF(String url, String fileName) async {
    try {
      ...
      String firebaseStoragePath =
          'pyq/$selectedCourse/semester$selectedSemester/$selectedSubject/$fileName.pdf';
          ...
          DropdownButton<String>(
            ...
            onChanged: (value) {
              setState(() {
                ...
                fetchPyQ(); // Fetch PyQ for the selected course, semester, and subject
              });
            },
  ...
  Future<void> fetchPyQ() async {
    ...
    try {
      final ListResult result = await FirebaseStorage.instance
          .ref('pyq/$selectedCourse/semester$selectedSemester/$selectedSubject/')
          .listAll();
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('PyQ fetched successfully'),
        ),
      );
    } catch (error) {
      print("Error fetching PyQ: $error");
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Error fetching PyQ'),
        ),
      );
    }
  }
